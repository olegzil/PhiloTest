...
fun <R> subsriber(progress:(Boolean)->Unit, recyclerView:RecyclerView, disposables: CompositeDisposable, selector: String, field: (R) -> String, parent: Single<List<R>>): Boolean {
